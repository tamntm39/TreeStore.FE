...
export function apiUserGetUserByIdGet$Json(http: HttpClient, rootUrl: string, params?: ApiUserGetUserByIdGet$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<UserResultCustomModel>> {
